...
class StretchIKControl:
    ...
    JOINT_BASE_ROTATION = "joint_base_revolution"
    JOINTS_BASE = [
    ...
    def __load_joint_limits(self, speed_profile: SpeedProfile) -> bool:
        ...
        for i, joint_name in enumerate(self.jacobian_joint_order):
            ...
            elif joint_name == self.JOINT_BASE_ROTATION:
    ...
    async def move_to_ee_pose_inverse_jacobian(
        self,
        goal: PoseStamped,
    ...
    def __execute_velocities(
        ...
        if move_base:
            ...
            if self.JOINT_BASE_ROTATION in clipped_velocities:
