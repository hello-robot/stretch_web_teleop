...
UVC_COLOR_SIZE = [1024, 768] # [3840,2880] [1920, 1080] [1280, 720] [1280, 800] [640, 480]
UVC_FPS = 100

UVC_VIDEO_INDEX = '/dev/hello-gripper-camera'
UVC_VIDEO_FORMAT = 'MJPG' # MJPG YUYV 

UVC_BRIGHTNESS =  -40         # brightness 0x00980900 (int)    : min=-64 max=64 step=1 default=0 value=0
UVC_CONTRAST = 40            # contrast 0x00980901 (int)    : min=0 max=64 step=1 default=32 value=32
UVC_SATURATION = 60          # saturation 0x00980902 (int)    : min=0 max=128 step=1 default=90 value=90
...
UVC_SHARPNESS = 100            # sharpness 0x0098091b (int)    : min=0 max=6 step=1 default=3 value=3
...
class GripperImagePublisherNode(Node):
    def __init__(self):
        ...
        self.publisher = self.create_publisher(Image, '/gripper_camera/color/image_rect_raw', 15)
