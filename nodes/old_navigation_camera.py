...
UVC_BRIGHTNESS = (
    10  # brightness 0x00980900 (int)    : min=-64 max=64 step=1 default=0 value=0
)
UVC_CONTRAST = (
    30  # contrast 0x00980901 (int)    : min=0 max=64 step=1 default=32 value=32
)
UVC_SATURATION = (
    80  # saturation 0x00980902 (int)    : min=0 max=128 step=1 default=90 value=90
)
...
UVC_SHARPNESS = (
    3  # sharpness 0x0098091b (int)    : min=0 max=6 step=1 default=3 value=3
)
UVC_BACKLIT_COMP = 1  # backlight_compensation 0x0098091c (int)    : min=0 max=2 step=1 default=1 value=1
UVC_EXPOSURE_TIME = 150  # exposure_time_absolute 0x009a0902 (int)    : min=1 max=5000 step=1 default=157 value=157 flags=inactive
